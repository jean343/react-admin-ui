...
var NavItemMaximized = _styledComponents.default.li.withConfig({
  ...
  return props.open && (0, _styledComponents.css)(["background:", ";border:1px solid ", ";> .sub-nav{max-height:", ";}"], function (props) {
