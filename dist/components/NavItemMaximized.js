...
})(["position:relative;margin:0;transition:background 0.3s ease-in-out,border 0.1s ease-in-out;cursor:pointer;border:", " solid transparent;overflow:hidden;flex-shrink:0;", " i:not(.caret-left-icon),svg:not(.caret-left-icon){transition:color 0.1s ease-in-out;margin-right:0.5rem;color:", ";}a{display:flex;align-items:center;padding:0 ", ";height:38px;text-decoration:none !important;color:", " !important;transition:background 0.1s ease-in-out;}a span{flex:1;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}a:hover{background:", ";}a:hover i,a:hover svg{color:", ";}&:first-child{border-top:none;}.caret-left-icon{transition:transform 0.3s ease-in-out;transform:", ";}", " border-left:3px solid transparent;border-left-color:", ";border-left:", ";border-right:none;"], function (props) {
