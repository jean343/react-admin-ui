...
})(["@media print{display:none;height:0;overflow:hidden;}height:", ";border-bottom:", " solid ", ";background-color:white;display:flex;.toolbar-item{cursor:pointer;width:", ";display:flex;align-items:center;justify-content:center;transition:background-color 0.1s ease-in-out;}.toolbar-item:hover{background-color:", ";}"], function (props) {
