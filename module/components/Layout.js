...
})(["display:flex;flex-direction:column;min-height:100vh;@media screen{color:", ";}a{color:", ";text-decoration:none;}a:hover{color:", ";text-decoration:underline;}"], props => [props["body-color"], (props.theme || {})["body-color"], [props["gray-900"], (props.theme || {})["gray-900"], `#313742`].filter(v => v !== void 0)[0]].filter(v => v !== void 0)[0], props => [props["link-color"], (props.theme || {})["link-color"], [props["blue"], (props.theme || {})["blue"], `#20a8d8`].filter(v => v !== void 0)[0]].filter(v => v !== void 0)[0], props => require('tinycolor2')([props["link-color"], (props.theme || {})["link-color"], [props["blue"], (props.theme || {})["blue"], `#20a8d8`].filter(v => v !== void 0)[0]].filter(v => v !== void 0)[0]).darken(parseFloat(`15%`)).toHex8String());
