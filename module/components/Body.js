...
})(["display:flex;flex-direction:row;flex-grow:1;overflow-x:hidden;@media screen{transform:translateY(", ");background-color:", ";}"], props => [props["navbar-height"], (props.theme || {})["navbar-height"], `55px`].filter(v => v !== void 0)[0], props => [props["body-background-color"], (props.theme || {})["body-background-color"], `#f5f6f7`].filter(v => v !== void 0)[0]);
