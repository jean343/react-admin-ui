...
})(["display:flex;flex-direction:row;flex-grow:1;overflow-x:hidden;@media screen{margin-top:", ";background-color:", ";}"], props => [props["navbar-height"], (props.theme || {})["navbar-height"], `55px`].filter(v => v !== void 0)[0], props => [props["body-bg"], (props.theme || {})["body-bg"], [props["gray-100"], (props.theme || {})["gray-100"], `#f8f8fa`].filter(v => v !== void 0)[0]].filter(v => v !== void 0)[0]);
